...
func (x *Transaction) GetResult() *TransactionResult {
	if x != nil {
		if x, ok := x.Payload.(*Transaction_Result); ok {
			return x.Result
		}
	}
	return nil
...
func (x *Transaction) GetError() string {
	if x != nil {
		if x, ok := x.Payload.(*Transaction_Error); ok {
			return x.Error
		}
	}
	return ""
...
type Transaction_Result struct {
	Result *TransactionResult `protobuf:"bytes,2,opt,name=result,proto3,oneof"`
}
...
func (*Transaction_Result) isTransaction_Payload() {}

func (*Transaction_Error) isTransaction_Payload() {}
...
func (x *TransactionResult) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
var file_proto_solana_wallet_proto_rawDesc = string([]byte{
	...
	0x0b, 0x6c, 0x61, 0x73, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x22, 0x9a, 0x02, 0x0a,
	...
	0x75, 0x65, 0x12, 0x25, 0x0a, 0x0e, 0x68, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x5f, 0x70, 0x72,
	0x69, 0x63, 0x65, 0x73, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x01, 0x52, 0x0d, 0x68, 0x69, 0x73, 0x74,
	0x6f, 0x72, 0x79, 0x50, 0x72, 0x69, 0x63, 0x65, 0x73, 0x22, 0x8f, 0x01, 0x0a, 0x0b, 0x54, 0x72,
	0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x6a, 0x73, 0x6f,
	0x6e, 0x72, 0x70, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6a, 0x73, 0x6f, 0x6e,
	0x72, 0x70, 0x63, 0x12, 0x33, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x02, 0x20,
	...
	0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xbd, 0x01, 0x0a, 0x11,
	...
	,
...
var file_proto_solana_wallet_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_proto_solana_wallet_proto_goTypes = []any{
	...
	(*TransactionResult)(nil),  // 4: wallet.TransactionResult
	(*Meta)(nil),               // 5: wallet.Meta
	(*InnerInstruction)(nil),   // 6: wallet.InnerInstruction
	(*TokenBalance)(nil),       // 7: wallet.TokenBalance
	(*TokenAmount)(nil),        // 8: wallet.TokenAmount
	(*Reward)(nil),             // 9: wallet.Reward
	(*Status)(nil),             // 10: wallet.Status
	(*TransactionData)(nil),    // 11: wallet.TransactionData
	(*TransactionMessage)(nil), // 12: wallet.TransactionMessage
	(*AddressTableLookup)(nil), // 13: wallet.AddressTableLookup
	(*MessageHeader)(nil),      // 14: wallet.MessageHeader
	(*Instruction)(nil),        // 15: wallet.Instruction
	(*StatusMessage)(nil),      // 16: wallet.StatusMessage
}
var file_proto_solana_wallet_proto_depIdxs = []int32{
	...
	4,  // 2: wallet.Transaction.result:type_name -> wallet.TransactionResult
	5,  // 3: wallet.TransactionResult.meta:type_name -> wallet.Meta
	11, // 4: wallet.TransactionResult.transaction:type_name -> wallet.TransactionData
	6,  // 5: wallet.Meta.inner_instructions:type_name -> wallet.InnerInstruction
	7,  // 6: wallet.Meta.post_token_balances:type_name -> wallet.TokenBalance
	7,  // 7: wallet.Meta.pre_token_balances:type_name -> wallet.TokenBalance
	9,  // 8: wallet.Meta.rewards:type_name -> wallet.Reward
	10, // 9: wallet.Meta.status:type_name -> wallet.Status
	15, // 10: wallet.InnerInstruction.instructions:type_name -> wallet.Instruction
	8,  // 11: wallet.TokenBalance.ui_token_amount:type_name -> wallet.TokenAmount
	12, // 12: wallet.TransactionData.message:type_name -> wallet.TransactionMessage
	13, // 13: wallet.TransactionMessage.address_table_lookups:type_name -> wallet.AddressTableLookup
	14, // 14: wallet.TransactionMessage.header:type_name -> wallet.MessageHeader
	15, // 15: wallet.TransactionMessage.instructions:type_name -> wallet.Instruction
	0,  // 16: wallet.WalletService.AddWallet:input_type -> wallet.WalletRequest
	1,  // 17: wallet.WalletService.AddWallet:output_type -> wallet.WalletResponse
...
func file_proto_solana_wallet_proto_init() {
	...
	file_proto_solana_wallet_proto_msgTypes[3].OneofWrappers = []any{
		(*Transaction_Result)(nil),
		(*Transaction_Error)(nil),
	}
	file_proto_solana_wallet_proto_msgTypes[10].OneofWrappers = []any{
		(*Status_Ok)(nil),
